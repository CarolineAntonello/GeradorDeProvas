...
namespace GeradorDeProvas.Infra.Data
{
    public class MateriaBDRepository : IMateriaRepository
    {
        ...
        public const string _sqlSelectNomeLike = @"SELECT m.Id
                                 ,m.NomeMateria
                                 ,m.SerieId
                                 ,m.DisciplinaId
	                             ,d.NomeDisciplina
                           ...
                           INNER JOIN TBDisciplina AS d ON d.Id = m.DisciplinaId
                           INNER JOIN TBSerie AS s ON s.Id = m.SerieId
                                           WHERE m.NomeMateria LIKE @NomeMateria";
        ...
        public List<Materia> Pesquisar(string texto)
        {
            Dictionary<string, object> parms = new Dictionary<string, object> { { "NomeMateria", '%' + texto + '%' } };
